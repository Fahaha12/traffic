...
watch(() => props.camera, (newCamera) => {
  if (newCamera) {
    Object.assign(form, {
      ...
      lat: newCamera.position.lat.toString(),
      lng: newCamera.position.lng.toString(),
      width: newCamera.resolution.width,
      height: newCamera.resolution.height,
      fps: newCamera.fps,
      direction: newCamera.direction || 0
    })
  }
}, { immediate: true })
